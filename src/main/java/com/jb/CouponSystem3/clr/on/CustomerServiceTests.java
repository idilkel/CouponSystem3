...
public class CustomerServiceTests implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        try {
            ...
            Coupon coupon1 = customerService2.getOneCouponById(1);
            Coupon coupon2 = customerService2.getOneCouponById(2);
            Coupon coupon3 = customerService2.getOneCouponById(3);
            Coupon coupon4 = customerService2.getOneCouponById(4);
            Coupon coupon5 = customerService2.getOneCouponById(5);
            ...
            Set<Coupon> couponsOfCustomer2 = customerService2.getCustomerCoupons();
            ...
            customerService2.purchaseCoupon(coupon1);
            customerService2.purchaseCoupon(coupon2);
            customerService2.purchaseCoupon(coupon3);
            customerService2.purchaseCoupon(coupon4);
            customerService2.purchaseCoupon(coupon5);

            System.out.println("Customer#2 coupons after purchasing the coupons (get all coupons of the logged-in customer)");
            couponsOfCustomer2 = customerService2.getCustomerCoupons();
            TableUtils.drawCouponsBuffer(couponsOfCustomer2);
            ...
            customerService3.purchaseCoupon(coupon1);
            customerService3.purchaseCoupon(coupon2);
            customerService3.purchaseCoupon(coupon4);
            System.out.println("Customer#3 coupons after purchasing the coupons");
            TableUtils.drawCouponsBuffer(customerService3.getCustomerCoupons());

            CustomerService customerService5 = (CustomerService) loginManager.login("lior@gmail.com", "lior1234", ClientType.CUSTOMER);
            customerService5.purchaseCoupon(coupon1);
            customerService5.purchaseCoupon(coupon2);
            customerService5.purchaseCoupon(coupon4);
            System.out.println("Customer#5 coupons after purchasing the coupons");
            TableUtils.drawCouponsBuffer(customerService5.getCustomerCoupons());

            HeadlineUtils.printHeadline2("Get all coupons of the logged-in customer#2 from fashion category:");
            TableUtils.drawCouponsBuffer(customerService2.getCustomerCoupons(Category.FASHION));

            HeadlineUtils.printHeadline2("Getting all the Coupons of logged in customer#2 with maximum 50NIS");
            TableUtils.drawCouponsBuffer(customerService2.getCustomerCoupons(50));
        ...
        try {
            ...
            CustomerService customerService2 = (CustomerService) loginManager.login("moshe@gmail.com", "moshe1234", ClientType.CUSTOMER);
            Coupon couponZero = customerService2.getOneCouponById(3);
            ...
            customerService2.purchaseCoupon(couponZero);
        } catch (CouponSystemException e) {
            //e.printStackTrace();
            System.out.println(e);
        }
        ...
        try {
            ...
            CustomerService customerService2 = (CustomerService) loginManager.login("moshe@gmail.com", "moshe1234", ClientType.CUSTOMER);
            Coupon couponExp = customerService2.getOneCouponById(7);
            System.out.println("Trying to purchase the following coupon:");
            TableUtils.drawOneCouponBuffer(couponExp);
            System.out.println("Purchasing response:");
            customerService2.purchaseCoupon(couponExp);
        } catch (CouponSystemException e) {
            //e.printStackTrace();
            System.out.println(e);
        }
